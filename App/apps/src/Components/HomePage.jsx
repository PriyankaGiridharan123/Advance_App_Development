          ...
          <div className="home-page">
            ...
            <div className="search-container">
              ...
              <div className="suggestionss">
                ...
                <Link to="/applicantlogin" className="suggestion">Frontend Developer</Link>
                <Link to="/applicantlogin" className="suggestion">Backend Developer</Link>
                <Link to="/applicantlogin" className="suggestion">Full Stack Developer</Link>
                <Link to="/applicantlogin" className="suggestion">UI/UX Designer</Link>
              </div>
            </div>
          </div>
        </main>
